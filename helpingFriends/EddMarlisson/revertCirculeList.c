...
void inverter(LISTA *l)
{
    ...
    NO *atual = l->cabeca->prox; // aponta para o primeiro nó da lista
    NO *anterior = l->cabeca;    // aponta para a cabeça da lista
    NO *prox = atual->prox;      // aponta para o segundo nó da lista

    while (atual != l->cabeca)
    {
        // inverte o ponteiro do nó atual para apontar para o nó anterior
        atual->prox = anterior;

        // atualiza o nó anterior para o nó atual
        anterior = atual;

        // atualiza o nó atual para o nó seguinte
        atual = prox;

        // atualiza o nó seguinte para o próximo nó da lista original
        prox = prox->prox;
    }

    // atualizar a cabeca da lista, para apontar para o ultimo no
